...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const TG = {
        token: "8074580649:AAGsTAbmxob9dh7YstEtERp_zz-BD5xfA9A", // Your @Botfather Bot token Ex. "7643207473:AAGAmVT-NbhA5duaE2KqkM0rVbKqWsWleQE
        chat_id: "7776490718", // ID of the chat for notifications (include the minus if present) Ex. "-1033337653892"
